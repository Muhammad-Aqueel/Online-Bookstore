...
<div x-data="{ open: false }" class="flex">
    ...
    <aside 
        x-show="open"
        x-transition
        class="w-64 h-screen bg-white border-r shadow-md flex flex-col p-4 fixed xl:relative z-30"
    >
        <!-- Close button (mobile) -->
        <button @click="open = false" class="self-end mb-4 text-gray-600 hover:text-sky-600 xl:hidden">
            <i class="fas fa-times"></i>
        </button>

        <!-- Logo / Title -->
        <div class="mb-6">
            <h1 class="text-xl font-bold text-sky-800"><?php echo htmlspecialchars(SITE_NAME); ?></h1>
        </div>

        <!-- Navigation -->
        <nav class="flex flex-col space-y-3">
            <a href="<?= BASE_URL ?>/" class="flex items-center text-gray-700 hover:text-sky-600 hover:bg-gray-100 rounded-md px-3 py-2 transition">
                <i class="fas fa-home mr-2"></i> Home
            </a>
            <a href="<?= BASE_URL ?>/about.php" class="flex items-center text-gray-700 hover:text-sky-600 hover:bg-gray-100 rounded-md px-3 py-2 transition">
                <i class="fas fa-info-circle mr-2"></i> About
            </a>
            <a href="<?= BASE_URL ?>/contact.php" class="flex items-center text-gray-700 hover:text-sky-600 hover:bg-gray-100 rounded-md px-3 py-2 transition">
                <i class="fas fa-envelope mr-2"></i> Contact
            </a>
            <a href="<?= BASE_URL ?>/faq.php" class="flex items-center text-gray-700 hover:text-sky-600 hover:bg-gray-100 rounded-md px-3 py-2 transition">
    ...
    <div class="flex-1 flex flex-col min-h-screen">
        ...
        <header class="bg-white shadow-md">
            <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <button @click="open = !open" class="text-gray-600 hover:text-sky-600 xl:hidden mr-2">
                    <i class="fas fa-bars"></i>
                </button>

                <a href="<?= BASE_URL ?>" class="hidden md:block text-2xl font-bold text-sky-800">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="space-x-4 flex items-center">
                        ...
                        <?php else: ?>
                            <a href="<?= BASE_URL ?>/auth/login.php" class="bg-sky-600 text-white px-4 py-2 rounded-md hover:bg-sky-700 transition-colors duration-300"><i class="fas fa-right-to-bracket"></i></a>
                            <a href="<?= BASE_URL ?>/auth/register.php" class="bg-sky-600 text-white px-4 py-2 rounded-md hover:bg-sky-700 transition-colors duration-300"><i class="fas fa-user-plus"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
            </nav>
