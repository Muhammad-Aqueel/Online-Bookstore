...
<body class="bg-gray-100 font-sans leading-normal tracking-normal flex flex-col min-h-screen">
    <!-- Sidebar -->
    <aside id="sidebar"
        class="w-64 h-screen bg-white border-r shadow-md flex flex-col p-4 fixed xl:relative xl:hidden z-30
            transform -translate-x-full transition-transform duration-300 ease-in-out">
        
        <!-- Close button (mobile) -->
        <button id="closeSidebar" class="self-end mb-4 text-gray-600 hover:text-sky-600 xl:hidden">
            <i class="fas fa-times"></i>
        </button>

        <!-- Logo / Title -->
        <div class="mb-6">
            <h1 class="text-xl font-bold text-sky-800">
    ...
    <header class="bg-white shadow-md">
        <nav class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <button id="openSidebar" class="text-gray-600 hover:text-sky-600 xl:hidden mr-2">
